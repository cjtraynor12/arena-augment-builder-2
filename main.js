...
async function getItemsJson() {
    // First fetch item descriptions from stringtable
    await fetchItemDescriptions();
    
    // Then get the enhanced items data and display it
...
async function init() {
    ...
    // Fetch arena item descriptions after the page loads
    let p4 = fetchArenaItemDescriptions();
